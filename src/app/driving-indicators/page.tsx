...
export default function DrivingIndicatorsPage() {
  ...
  // Use UIMonthContext for selected month and dropdown options (syncs with Outcome Indicators)
  const {
    currentMonthAbbr,
    changeMonth,
  ...
  // Month options come from UIMonthContext (synced with AgentCore)
  const availableMonths = availableMonthsAbbr
