    ...
    >
      ...
      <div className="flex justify-between items-center">
        ...
        {(() => {
          ...
          // Use text-contains logic for flexible matching
          const isGreen = tag.includes("track") ||
                         tag.includes("increasing") ||
                         tag.includes("high") ||
                         tag.includes("exceeds");
          const isRed = tag.includes("attention") ||
                       tag.includes("declining") ||
                       tag.includes("risk") ||
                       tag.includes("low");
          ...
          const cls = isGreen
              ...
              : tag.includes("medium") || tag.includes("stable") || tag.includes("neutral")
